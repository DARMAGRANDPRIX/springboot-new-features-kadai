...
public class HouseController {
	...
	public String show(@PathVariable(name = "houseId") Integer houseId, Model model, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
	    ...
	    User user = userDetailsImpl != null ? userRepository.getReferenceById(userDetailsImpl.getUser().getId()) : null;
	    boolean userHasReviews = user != null && !reviewRepository.findByHouseIdAndUserId(houseId, user.getId()).isEmpty();
